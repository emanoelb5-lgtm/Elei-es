...
data class CandidateUncertainty(
    ...
    val parameterStressLow: Double?,
    val parameterStressHigh: Double?,
    val parameterStressHalfWidth: Double,
...
data class UncertaintyData(
    ...
    val parameterStressVariantCount: Int,
    val parameterStressSensitivity: String,
    val parameterStressAutomaticAdjustment: Boolean,
